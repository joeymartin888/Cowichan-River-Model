...
"""Upstream steamflows at Lake Cowichan"""
date_range=[pd.Timestamp('2010-01-01'), pd.Timestamp('2010-03-01')]
...
"""Downstream streamflows at Duncan for validation purposes if required"""
...
length=38000+dist_step #River Length - one distance step is added at the end as required for FTCS method
width=25 #River Width
slope=0.005 #River Slope
roughness=0.035 #Manning’s roughness constant (this is Lehigh River value)'
decay_coeff=0.015 #Decay coefficient from literature
disp_coeff=7.5 #Dispersion coefficient from literature
